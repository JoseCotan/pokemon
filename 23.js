...
document.getElementById('botonAtacar').addEventListener('click', function () {
    atacar(pokemonsUsuario1[0], pokemonsUsuario2[0], 3, 0);
});
...
function updatePokemonsSeleccionados1() {
    ...
    var checkboxes = document.querySelectorAll('input[name="pokemonJugador1"]:checked');
...
function updatePokemonsSeleccionados2() {
    ...
    var checkboxes = document.querySelectorAll('input[name="pokemonJugador2"]:checked');
...
function limitarSeleccion(fieldset, updateFunction) {
    ...
    checkboxes.forEach(checkbox => {
        checkbox.addEventListener('change', function () {
            var marcadas = fieldset.querySelectorAll('input[type="checkbox"]:checked');
...
var pokemonsUsuario1 = [pokemons.rattata, pokemons.bulbasaur, pokemons.jiglypuff];
...
function atacar(pokemonsSeleccionados1, pokemonsSeleccionados2, idAtaque, idPokemon) {
    let daño = 0;
